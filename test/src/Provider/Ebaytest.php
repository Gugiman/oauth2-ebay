...
namespace Gugiman\OAuth2\Client\Test\Provider;

use Gugiman\OAuth2\Client\Provider\Ebay;
use Mockery as m;
...
class EbayTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetAccessToken()
    {
        ...
        $this->assertNull($token->getResourceOwnerId(), 'Ebay does not return user ID with access token. Expected null.');
    }
}
